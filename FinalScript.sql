...
CREATE TABLE ONLINE_GROUP_REGULAR(
	...
	CATEGORY NUMBER NOT NULL,
	MEM_NO NUMBER NOT NULL,
	TABLE_NO NUMBER DEFAULT 3 NOT NULL REFERENCES TABLE_NAME
);
...
CREATE TABLE ONLINE_CHALLENGE_D_DAY(
	...
	CATEGORY NUMBER NOT NULL,
	MEM_NO NUMBER NOT NULL,
	TABLE_NO NUMBER DEFAULT 4 NOT NULL REFERENCES TABLE_NAME
);
...
COMMENT ON COLUMN ONLINE_CHALLENGE_D_DAY.ON_CHL_D_CONTENT IS '내용';
...
CREATE TABLE ONLINE_CHALLENGE_REGULAR(
	...
	CATEGORY NUMBER NOT NULL,
	MEM_NO NUMBER NOT NULL,
	TABLE_NO NUMBER DEFAULT 5 NOT NULL REFERENCES TABLE_NAME
);
...
COMMENT ON COLUMN ONLINE_CHALLENGE_REGULAR.ON_CHL_REG_CONTENT IS '내용';
...
CREATE TABLE OFFLINE_GROUP_ONCE(
	...
	CATEGORY NUMBER NOT NULL,
	MEM_NO NUMBER NOT NULL,
	TABLE_NO NUMBER DEFAULT 6 NOT NULL REFERENCES TABLE_NAME
);
...
CREATE TABLE OFFLINE_GROUP_REGULAR(
	...
	CATEGORY NUMBER NOT NULL,
	MEM_NO NUMBER NOT NULL,
	TABLE_NO NUMBER DEFAULT 7 NOT NULL REFERENCES TABLE_NAME
);
...
CREATE TABLE OFFLINE_CHALLENGE_D_DAY(
	...
	CATEGORY NUMBER NOT NULL,
	MEM_NO NUMBER NOT NULL,
	TABLE_NO NUMBER DEFAULT 8 NOT NULL REFERENCES TABLE_NAME
);
...
COMMENT ON COLUMN OFFLINE_CHALLENGE_D_DAY.OFF_CHL_D_CONTENT IS '내용';
...
CREATE TABLE OFFLINE_CHALLENGE_REGULAR(
	...
	CATEGORY NUMBER NOT NULL,
	MEM_NO NUMBER NOT NULL,
	TABLE_NO NUMBER DEFAULT 9 NOT NULL REFERENCES TABLE_NAME
);
...
COMMENT ON COLUMN OFFLINE_CHALLENGE_REGULAR.OFF_CHL_REG_CONTENT IS '내용';
