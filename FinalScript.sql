...
CREATE TABLE ONLINE_GROUP_ONCE(
	...
	START_DATE VARCHAR2(400) NOT NULL,
	END_DATE VARCHAR2(400) NOT NULL,
	START_ENTER VARCHAR2(400) NOT NULL,
	END_ENTER VARCHAR2(400) NOT NULL,
...
CREATE TABLE ALERT(
    ...
    ALERT_READ_NY CHAR(10) DEFAULT 'N' CONSTRAINT ALERT_READ_NY
_CK CHECK(ALERT_READ_NY IN('Y','N'))
);
