...
CREATE TABLE ONLINE_GROUP_ONCE(
	...
	ON_GROUP_ONCE_EMAIL VARCHAR2(100) NOT NULL,
	ON_GROUP_ONCE_SIMPLE VARCHAR2(400) NOT NULL,
	ENROLL_DATE DATE DEFAULT SYSDATE NOT NULL,
	MODIFY_DATE DATE DEFAULT SYSDATE,
	ON_GROUP_ONCE_START_DATE DATE NOT NULL,
	ON_GROUP_ONCE_END_DATE DATE NOT NULL,
	ON_GROUP_ONCE_START_ENTER DATE NOT NULL,
	ON_GROUP_ONCE_END_ENTER DATE NOT NULL,
	...
	URL VARCHAR2(4000),
	MAX NUMBER NOT NULL,
	MAX_ACCESS NUMBER NOT NULL,
	ADULT_ACCESS NUMBER NOT NULL,
...
COMMENT ON COLUMN ONLINE_GROUP_ONCE.ON_GROUP_ONCE_EMAIL IS '이메일';
COMMENT ON COLUMN ONLINE_GROUP_ONCE.ON_GROUP_ONCE_SIMPLE IS '간단소개';
COMMENT ON COLUMN ONLINE_GROUP_ONCE.ENROLL_DATE IS '등록일자';
COMMENT ON COLUMN ONLINE_GROUP_ONCE.MODIFY_DATE IS '수정일자';
COMMENT ON COLUMN ONLINE_GROUP_ONCE.ON_GROUP_ONCE_START_DATE IS '모임시작일자';
COMMENT ON COLUMN ONLINE_GROUP_ONCE.ON_GROUP_ONCE_END_DATE IS '모임종료일자';
COMMENT ON COLUMN ONLINE_GROUP_ONCE.ON_GROUP_ONCE_START_ENTER IS '접수시작일자';
COMMENT ON COLUMN ONLINE_GROUP_ONCE.ON_GROUP_ONCE_END_ENTER IS '접수종료일자';
COMMENT ON COLUMN ONLINE_GROUP_ONCE.ON_GROUP_ONCE_CONTENT IS '상세내용';
...
COMMENT ON COLUMN ONLINE_GROUP_ONCE.PASSWORD IS '비밀번호';
...
CREATE TABLE ONLINE_GROUP_REGULAR(
	...
	ON_GROUP_REG_EMAIL VARCHAR2(100) NOT NULL,
	ON_GROUP_REG_SIMPLE VARCHAR2(400) NOT NULL,
	ENROLL_DATE DATE DEFAULT SYSDATE NOT NULL,
	MODIFY_DATE DATE DEFAULT SYSDATE,
	ON_GROUP_REG_START_DATE DATE NOT NULL,
	ON_GROUP_REG_END_DATE DATE NOT NULL,
	ON_GROUP_REG_START_ENTER DATE NOT NULL,
	ON_GROUP_REG_END_ENTER DATE NOT NULL,
...
COMMENT ON COLUMN ONLINE_GROUP_REGULAR.ON_GROUP_REG_EMAIL IS '이메일';
COMMENT ON COLUMN ONLINE_GROUP_REGULAR.ON_GROUP_REG_SIMPLE IS '간단소개';
COMMENT ON COLUMN ONLINE_GROUP_REGULAR.ENROLL_DATE IS '등록일자';
COMMENT ON COLUMN ONLINE_GROUP_REGULAR.MODIFY_DATE IS '수정일자';
COMMENT ON COLUMN ONLINE_GROUP_REGULAR.ON_GROUP_REG_START_DATE IS '모임시작일자';
COMMENT ON COLUMN ONLINE_GROUP_REGULAR.ON_GROUP_REG_END_DATE IS '모임종료일자';
COMMENT ON COLUMN ONLINE_GROUP_REGULAR.ON_GROUP_REG_START_ENTER IS '접수시작일자';
COMMENT ON COLUMN ONLINE_GROUP_REGULAR.ON_GROUP_REG_END_ENTER IS '접수종료일자';
COMMENT ON COLUMN ONLINE_GROUP_REGULAR.ON_GROUP_REG_CONTENT IS '상세내용';
...
COMMENT ON COLUMN ONLINE_GROUP_REGULAR.PASSWORD IS '비밀번호';
...
CREATE TABLE ONLINE_CHALLENGE_D_DAY(
	ON_CHL_D_NO NUMBER CONSTRAINT ON_CHALLENGE_D_NO_PK PRIMARY KEY,
	ON_CHL_D_TITLE VARCHAR2(100) NOT NULL,
	ON_CHL_D_ID VARCHAR2(100) NOT NULL,
	ON_CHL_D_EMAIL VARCHAR2(100) NOT NULL,
	ON_CHL_D_SIMPLE VARCHAR2(400) NOT NULL,
	ENROLL_DATE DATE DEFAULT SYSDATE NOT NULL,
	MODIFY_DATE DATE DEFAULT SYSDATE,
    ON_CHL_D_START_DATE DATE NOT NULL,
	ON_CHL_D_END_DATE DATE NOT NULL,
	ON_CHL_D_START_ENTER DATE NOT NULL,
	ON_CHL_D_END_ENTER DATE NOT NULL,
	ON_CHL_D_CONTENT VARCHAR2(4000) NOT NULL,
	ADDRESS VARCHAR2(4000),
	ADDRESS_DETAIL VARCHAR2(4000),
    DISPLAY_NY VARCHAR2(100) NOT NULL,
    PASSWORD VARCHAR2(4000),
...
-- 온라인목표디데이 컬럼명
COMMENT ON COLUMN ONLINE_CHALLENGE_D_DAY.ON_CHL_D_NO IS '모임번호';
COMMENT ON COLUMN ONLINE_CHALLENGE_D_DAY.ON_CHL_D_TITLE IS '모임명';
COMMENT ON COLUMN ONLINE_CHALLENGE_D_DAY.ON_CHL_D_ID IS '개설자';
COMMENT ON COLUMN ONLINE_CHALLENGE_D_DAY.ON_CHL_D_EMAIL IS '이메일';
COMMENT ON COLUMN ONLINE_CHALLENGE_D_DAY.ON_CHL_D_SIMPLE IS '간단소개';
COMMENT ON COLUMN ONLINE_CHALLENGE_D_DAY.ENROLL_DATE IS '등록일자';
COMMENT ON COLUMN ONLINE_CHALLENGE_D_DAY.MODIFY_DATE IS '수정일자';
COMMENT ON COLUMN ONLINE_CHALLENGE_D_DAY.ON_CHL_D_START_DATE IS '모임시작일자';
COMMENT ON COLUMN ONLINE_CHALLENGE_D_DAY.ON_CHL_D_END_DATE IS '모임종료일자';
COMMENT ON COLUMN ONLINE_CHALLENGE_D_DAY.ON_CHL_D_START_ENTER IS '접수시작일자';
COMMENT ON COLUMN ONLINE_CHALLENGE_D_DAY.ON_CHL_D_END_ENTER IS '접수종료일자';
COMMENT ON COLUMN ONLINE_CHALLENGE_D_DAY.ON_CHL_D_CONTENT IS '상세내용';
...
COMMENT ON COLUMN ONLINE_CHALLENGE_D_DAY.PASSWORD IS '비밀번호';
...
CREATE TABLE ONLINE_CHALLENGE_REGULAR(
	ON_CHL_REG_NO NUMBER CONSTRAINT ON_CHALLENGE_REG_NO_PK PRIMARY KEY,
	ON_CHL_REG_TITLE VARCHAR2(100) NOT NULL,
	ON_CHL_REG_ID VARCHAR2(100) NOT NULL,
	ON_CHL_REG_EMAIL VARCHAR2(100) NOT NULL,
	ON_CHL_REG_SIMPLE VARCHAR2(400) NOT NULL,
	ENROLL_DATE DATE DEFAULT SYSDATE NOT NULL,
	MODIFY_DATE DATE DEFAULT SYSDATE,
    ON_CHL_REG_START_DATE DATE NOT NULL,
	ON_CHL_REG_END_DATE DATE NOT NULL,
	ON_CHL_REG_START_ENTER DATE NOT NULL,
	ON_CHL_REG_END_ENTER DATE NOT NULL,
	ON_CHL_REG_CONTENT VARCHAR2(4000) NOT NULL,
	ADDRESS VARCHAR2(4000),
	ADDRESS_DETAIL VARCHAR2(4000),
    DISPLAY_NY VARCHAR2(100) NOT NULL,
    PASSWORD VARCHAR2(4000),
...
-- 온라인목표정기 컬럼명
COMMENT ON COLUMN ONLINE_CHALLENGE_REGULAR.ON_CHL_REG_NO IS '모임번호';
COMMENT ON COLUMN ONLINE_CHALLENGE_REGULAR.ON_CHL_REG_TITLE IS '모임명';
COMMENT ON COLUMN ONLINE_CHALLENGE_REGULAR.ON_CHL_REG_ID IS '개설자';
COMMENT ON COLUMN ONLINE_CHALLENGE_REGULAR.ON_CHL_REG_EMAIL IS '이메일';
COMMENT ON COLUMN ONLINE_CHALLENGE_REGULAR.ON_CHL_REG_SIMPLE IS '간단소개';
...
COMMENT ON COLUMN ONLINE_CHALLENGE_REGULAR.ON_CHL_REG_START_DATE IS '모임시작일자';
COMMENT ON COLUMN ONLINE_CHALLENGE_REGULAR.ON_CHL_REG_END_DATE IS '모임종료일자';
COMMENT ON COLUMN ONLINE_CHALLENGE_REGULAR.ON_CHL_REG_START_ENTER IS '접수시작일자';
COMMENT ON COLUMN ONLINE_CHALLENGE_REGULAR.ON_CHL_REG_END_ENTER IS '접수종료일자';
COMMENT ON COLUMN ONLINE_CHALLENGE_REGULAR.ON_CHL_REG_CONTENT IS '상세내용';
...
COMMENT ON COLUMN ONLINE_CHALLENGE_REGULAR.PASSWORD IS '비밀번호';
...
CREATE TABLE OFFLINE_GROUP_ONCE(
	...
	OFF_GROUP_ONCE_EMAIL VARCHAR2(100) NOT NULL,
	OFF_GROUP_ONCE_SIMPLE VARCHAR2(400) NOT NULL,
	ENROLL_DATE DATE DEFAULT SYSDATE NOT NULL,
	MODIFY_DATE DATE DEFAULT SYSDATE,
    OFF_GROUP_ONCE_START_DATE DATE NOT NULL,
	OFF_GROUP_ONCE_END_DATE DATE NOT NULL,
	OFF_GROUP_ONCE_START_ENTER DATE NOT NULL,
	OFF_GROUP_ONCE_END_ENTER DATE NOT NULL,
...
COMMENT ON COLUMN OFFLINE_GROUP_ONCE.OFF_GROUP_ONCE_EMAIL IS '이메일';
COMMENT ON COLUMN OFFLINE_GROUP_ONCE.OFF_GROUP_ONCE_SIMPLE IS '간단소개';
COMMENT ON COLUMN OFFLINE_GROUP_ONCE.ENROLL_DATE IS '등록일자';
COMMENT ON COLUMN OFFLINE_GROUP_ONCE.MODIFY_DATE IS '수정일자';
COMMENT ON COLUMN OFFLINE_GROUP_ONCE.OFF_GROUP_ONCE_START_DATE IS '모임시작일자';
COMMENT ON COLUMN OFFLINE_GROUP_ONCE.OFF_GROUP_ONCE_END_DATE IS '모임종료일자';
COMMENT ON COLUMN OFFLINE_GROUP_ONCE.OFF_GROUP_ONCE_START_ENTER IS '접수시작일자';
COMMENT ON COLUMN OFFLINE_GROUP_ONCE.OFF_GROUP_ONCE_END_ENTER IS '접수종료일자';
COMMENT ON COLUMN OFFLINE_GROUP_ONCE.OFF_GROUP_ONCE_CONTENT IS '상세내용';
...
COMMENT ON COLUMN OFFLINE_GROUP_ONCE.PASSWORD IS '비밀번호';
...
CREATE TABLE OFFLINE_GROUP_REGULAR(
	...
	OFF_GROUP_REG_EMAIL VARCHAR2(100) NOT NULL,
	OFF_GROUP_REG_SIMPLE VARCHAR2(400) NOT NULL,
	ENROLL_DATE DATE DEFAULT SYSDATE NOT NULL,
	MODIFY_DATE DATE DEFAULT SYSDATE,
    OFF_GROUP_REG_START_DATE DATE NOT NULL,
	OFF_GROUP_REG_END_DATE DATE NOT NULL,
	OFF_GROUP_REG_START_ENTER DATE NOT NULL,
	OFF_GROUP_REG_END_ENTER DATE NOT NULL,
...
COMMENT ON COLUMN OFFLINE_GROUP_REGULAR.OFF_GROUP_REG_EMAIL IS '이메일';
COMMENT ON COLUMN OFFLINE_GROUP_REGULAR.OFF_GROUP_REG_SIMPLE IS '간단소개';
COMMENT ON COLUMN OFFLINE_GROUP_REGULAR.ENROLL_DATE IS '등록일자';
COMMENT ON COLUMN OFFLINE_GROUP_REGULAR.MODIFY_DATE IS '수정일자';
COMMENT ON COLUMN OFFLINE_GROUP_REGULAR.OFF_GROUP_REG_START_DATE IS '모임시작일자';
COMMENT ON COLUMN OFFLINE_GROUP_REGULAR.OFF_GROUP_REG_END_DATE IS '모임종료일자';
COMMENT ON COLUMN OFFLINE_GROUP_REGULAR.OFF_GROUP_REG_START_ENTER IS '접수시작일자';
COMMENT ON COLUMN OFFLINE_GROUP_REGULAR.OFF_GROUP_REG_END_ENTER IS '접수종료일자';
COMMENT ON COLUMN OFFLINE_GROUP_REGULAR.OFF_GROUP_REG_CONTENT IS '상세내용';
...
COMMENT ON COLUMN OFFLINE_GROUP_REGULAR.PASSWORD IS '비밀번호';
...
CREATE TABLE OFFLINE_CHALLENGE_D_DAY(
	OFF_CHL_D_NO NUMBER CONSTRAINT OFF_CHALLENGE_D_NO_PK PRIMARY KEY,
	OFF_CHL_D_TITLE VARCHAR2(100) NOT NULL,
	OFF_CHL_D_ID VARCHAR2(100) NOT NULL,
	OFF_CHL_D_EMAIL VARCHAR2(100) NOT NULL,
	OFF_CHL_D_SIMPLE VARCHAR2(400) NOT NULL,
	ENROLL_DATE DATE DEFAULT SYSDATE NOT NULL,
	MODIFY_DATE DATE DEFAULT SYSDATE,
    OFF_CHL_D_START_DATE DATE NOT NULL,
	OFF_CHL_D_END_DATE DATE NOT NULL,
	OFF_CHL_D_START_ENTER DATE NOT NULL,
	OFF_CHL_D_END_ENTER DATE NOT NULL,
	OFF_CHL_D_CONTENT VARCHAR2(4000) NOT NULL,
	ADDRESS VARCHAR2(4000),
	ADDRESS_DETAIL VARCHAR2(4000),
    DISPLAY_NY VARCHAR2(100) NOT NULL,
    PASSWORD VARCHAR2(4000),
...
-- 오프라인목표디데이 컬럼명
COMMENT ON COLUMN OFFLINE_CHALLENGE_D_DAY.OFF_CHL_D_NO IS '모임번호';
COMMENT ON COLUMN OFFLINE_CHALLENGE_D_DAY.OFF_CHL_D_TITLE IS '모임명';
COMMENT ON COLUMN OFFLINE_CHALLENGE_D_DAY.OFF_CHL_D_ID IS '개설자';
COMMENT ON COLUMN OFFLINE_CHALLENGE_D_DAY.OFF_CHL_D_EMAIL IS '이메일';
COMMENT ON COLUMN OFFLINE_CHALLENGE_D_DAY.OFF_CHL_D_SIMPLE IS '간단소개';
...
COMMENT ON COLUMN OFFLINE_CHALLENGE_D_DAY.OFF_CHL_D_START_DATE IS '모임시작일자';
COMMENT ON COLUMN OFFLINE_CHALLENGE_D_DAY.OFF_CHL_D_END_DATE IS '모임종료일자';
COMMENT ON COLUMN OFFLINE_CHALLENGE_D_DAY.OFF_CHL_D_START_ENTER IS '접수시작일자';
COMMENT ON COLUMN OFFLINE_CHALLENGE_D_DAY.OFF_CHL_D_END_ENTER IS '접수종료일자';
COMMENT ON COLUMN OFFLINE_CHALLENGE_D_DAY.OFF_CHL_D_CONTENT IS '상세내용';
...
COMMENT ON COLUMN OFFLINE_CHALLENGE_D_DAY.PASSWORD IS '비밀번호';
...
CREATE TABLE OFFLINE_CHALLENGE_REGULAR(
	OFF_CHL_REG_NO NUMBER CONSTRAINT OFF_CHALLENGE_REG_NO_PK PRIMARY KEY,
	OFF_CHL_REG_TITLE VARCHAR2(100) NOT NULL,
	OFF_CHL_REG_ID VARCHAR2(100) NOT NULL,
	OFF_CHL_REG_EMAIL VARCHAR2(100) NOT NULL,
	OFF_CHL_REG_SIMPLE VARCHAR2(400) NOT NULL,
	ENROLL_DATE DATE DEFAULT SYSDATE NOT NULL,
	MODIFY_DATE DATE DEFAULT SYSDATE,
    OFF_CHL_REG_START_DATE DATE NOT NULL,
	OFF_CHL_REG_END_DATE DATE NOT NULL,
	OFF_CHL_REG_START_ENTER DATE NOT NULL,
	OFF_CHL_REG_END_ENTER DATE NOT NULL,
	OFF_CHL_REG_CONTENT VARCHAR2(4000) NOT NULL,
	ADDRESS VARCHAR2(4000),
	ADDRESS_DETAIL VARCHAR2(4000),
    DISPLAY_NY VARCHAR2(100) NOT NULL,
    PASSWORD VARCHAR2(4000),
...
-- 오프라인목표정기 컬럼명
COMMENT ON COLUMN OFFLINE_CHALLENGE_REGULAR.OFF_CHL_REG_NO IS '모임번호';
COMMENT ON COLUMN OFFLINE_CHALLENGE_REGULAR.OFF_CHL_REG_TITLE IS '모임명';
COMMENT ON COLUMN OFFLINE_CHALLENGE_REGULAR.OFF_CHL_REG_ID IS '개설자';
COMMENT ON COLUMN OFFLINE_CHALLENGE_REGULAR.OFF_CHL_REG_EMAIL IS '이메일';
COMMENT ON COLUMN OFFLINE_CHALLENGE_REGULAR.OFF_CHL_REG_SIMPLE IS '간단소개';
...
COMMENT ON COLUMN OFFLINE_CHALLENGE_REGULAR.OFF_CHL_REG_START_DATE IS '모임시작일자';
COMMENT ON COLUMN OFFLINE_CHALLENGE_REGULAR.OFF_CHL_REG_END_DATE IS '모임종료일자';
COMMENT ON COLUMN OFFLINE_CHALLENGE_REGULAR.OFF_CHL_REG_START_ENTER IS '접수시작일자';
COMMENT ON COLUMN OFFLINE_CHALLENGE_REGULAR.OFF_CHL_REG_END_ENTER IS '접수종료일자';
COMMENT ON COLUMN OFFLINE_CHALLENGE_REGULAR.OFF_CHL_REG_CONTENT IS '상세내용';
...
COMMENT ON COLUMN OFFLINE_CHALLENGE_REGULAR.PASSWORD IS '비밀번호';
...
CREATE TABLE ENTRY_LIST(
    ...
    GROUP_TITLE VARCHAR2(60) NOT NULL,
