...
DROP SEQUENCE SEQ_GROUP_UPLOAD_NO;
...
-- 모입업로드 GROUP_UPLOAD
CREATE SEQUENCE SEQ_GROUP_UPLOAD_NO
    START WITH 1
    INCREMENT BY 1
    NOCYCLE
    NOCACHE;
...
CREATE TABLE GROUP_UPLOAD(
    GROUP_UPLOAD_NO NUMBER PRIMARY KEY,
	UPLOAD_DATE DATE DEFAULT SYSDATE NOT NULL,
    ORIGIN_NAME1 VARCHAR2(1000),
    ORIGIN_NAME2 VARCHAR2(1000),
    ORIGIN_NAME3 VARCHAR2(1000),
    ORIGIN_NAME4 VARCHAR2(1000),
    ORIGIN_NAME5 VARCHAR2(1000),
	FILE_PATH1 VARCHAR2(4000),
	FILE_PATH2 VARCHAR2(4000),
	FILE_PATH3 VARCHAR2(4000),
	FILE_PATH4 VARCHAR2(4000),
	FILE_PATH5 VARCHAR2(4000),
	FILE_LEVEL NUMBER,
    GROUP_NO NUMBER NOT NULL,
...
-- 업로드 컬럼명
COMMENT ON COLUMN GROUP_UPLOAD.GROUP_UPLOAD_NO IS '업로드번호';
COMMENT ON COLUMN GROUP_UPLOAD.UPLOAD_DATE IS '업로드날짜';
COMMENT ON COLUMN GROUP_UPLOAD.ORIGIN_NAME1 IS '원본파일명1';
COMMENT ON COLUMN GROUP_UPLOAD.ORIGIN_NAME2 IS '원본파일명2';
COMMENT ON COLUMN GROUP_UPLOAD.ORIGIN_NAME3 IS '원본파일명3';
COMMENT ON COLUMN GROUP_UPLOAD.ORIGIN_NAME4 IS '원본파일명4';
COMMENT ON COLUMN GROUP_UPLOAD.ORIGIN_NAME5 IS '원본파일명5';
COMMENT ON COLUMN GROUP_UPLOAD.FILE_PATH1 IS '수정파일명1';
COMMENT ON COLUMN GROUP_UPLOAD.FILE_PATH2 IS '수정파일명2';
COMMENT ON COLUMN GROUP_UPLOAD.FILE_PATH3 IS '수정파일명3';
COMMENT ON COLUMN GROUP_UPLOAD.FILE_PATH4 IS '수정파일명4';
COMMENT ON COLUMN GROUP_UPLOAD.FILE_PATH5 IS '수정파일명5';
COMMENT ON COLUMN GROUP_UPLOAD.FILE_LEVEL IS '파일레벨';
COMMENT ON COLUMN GROUP_UPLOAD.GROUP_NO IS '참조모임번호';
...
CREATE TABLE ALERT(
    ...
    ALERT_CONTENT VARCHAR(3000) NOT NULL,
