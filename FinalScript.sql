...
COMMENT ON COLUMN UPLOAD.CHANGE_NAME IS '수정파일명';
COMMENT ON COLUMN UPLOAD.GROUP_BOARD_NO IS '참조게시글번호';
COMMENT ON COLUMN UPLOAD.UPLOAD_DATE IS '업로드날짜';
COMMENT ON COLUMN UPLOAD.FILE_LEVEL IS '파일레벨';
COMMENT ON COLUMN UPLOAD.FILE_PATH IS '파일경로';
