	...
	<main id="content" class="event_add">
		<section>
			...
			<div class="content_area">
				...
				<form id="allForm" action="insertOnlineGroupOne.go" method="POST" encType="multipart/form-data" data-event_method_type="advance" data-open_type="open">
