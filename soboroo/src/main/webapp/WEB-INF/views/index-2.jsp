	...
	<div class="body-inner">
		<div class="banner-carousel banner-carousel-2 mb-0" style="height: 300px;">
			<div class="banner-carousel-item"
				style="background-image:url(${pageContext.request.contextPath}/resources/images/logo_3.png); height: 300px;">
				<div class="container">
			...
			<div class="banner-carousel-item"
				style="background-image:url(${pageContext.request.contextPath}/resources/images/logo_2.png); height: 300px;">
