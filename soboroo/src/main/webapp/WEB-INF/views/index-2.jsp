		        ...
		        <div class="row">
		          <div class="col-md-8 text-center text-md-left">
		              <div class="call-to-action-text">
		                <h3 class="action-title">새로운 모임을 주최해보세요!</h3>
		              </div>
		          </div><!-- Col end -->
		          <div class="col-md-4 text-center text-md-right mt-3 mt-md-0">
		              <div class="call-to-action-btn">
		                <a class="btn btn-primary" href="contact.html">새로운 만남</a>
		              </div>
		          </div><!-- col end -->
		        </div><!-- row end -->
		        ...
		        <div class="col-lg-4 col-md-6 mb-5">
		          <div class="ts-service-box">
		              <div class="ts-service-image-wrapper">
		                <img loading="lazy" class="w-100" ="${pageContext.request.contextPath}/resources/images/logo_3.png" alt="service-image">
		              </div>
		              <div class="d-flex">
