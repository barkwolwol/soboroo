...
<td><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="bedfd2dbc6dddfd3cedcdbd2d2fedbc6dfd3ced2db90ddd1d3">[admin2@google.com&#160;]</a></td>
<td>-</td>
<td>30 Mar 2020</td>
<td><span class="badge badge-pill bg-success-light">관리자</span></td>
<td class="text-end">
<a href="edit-customer.html" class="btn btn-sm btn-white text-success me-2"><i class="far fa-edit me-1"></i>상태변경</a>
<a class="btn btn-sm btn-white text-danger" href="#" data-bs-toggle="modal" data-bs-target="#delete_paid"><i class="far fa-trash-alt me-1"></i>탈퇴</a>
</td>
