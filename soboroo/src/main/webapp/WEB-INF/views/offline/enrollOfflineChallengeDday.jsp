...
<body>
	...
	<main id="content" class="event_add">
		<section>
			<div class="head_area">
				<h2>오프라인 D-DAY 개설하기</h2>
			</div>
		
			<div class="content_area">
			
				<form id="allForm" action="insertOfflineChallengeDday.go" method="POST" encType="multipart/form-data" data-event_method_type="advance" data-open_type="open">
					<input type="hidden" name="id" value="${ loginUser.memNickname }">
					<input type="hidden" name="memNo" value="${ loginUser.memNo }">
					<input type="hidden" name="tableNo" value="8">
