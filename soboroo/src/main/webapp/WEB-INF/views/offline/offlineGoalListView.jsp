        ...
        <div class="row">
          <div class="col-lg-12">
              <div class="banner-heading">
                <h1 class="banner-title">오프라인 목표모임</h1>
                <!-- 
        ...
        <div class="ts-service-box">
            ...
            <div class="d-flex">
              ...
              <div class="ts-service-info">
                  <h3 class="service-box-title"><a href="detail.off?groupNum=2" target="_blank">Zero Harm Everyday</a></h3>
      ...
      <div class="col-lg-4 col-md-6 mb-5">
        <div class="ts-service-box">
            ...
            <div class="d-flex">
              ...
              <div class="ts-service-info">
                  <h3 class="service-box-title"><a href="detail.off?groupNum=2" target="_blank">Virtual Construction</a></h3>
                  <p>You have ideas, goals, and dreams. We have a culturally diverse, forward thinking team looking for talent like. Lorem ipsum dolor suscipit.</p>
                  <a class="learn-more d-inline-block" href="service-single.html" aria-label="service-details"><i class="fa fa-caret-right"></i> Learn more</a>
              </div>
            </div>
      ...
      <div class="col-lg-4 col-md-6 mb-5">
        <div class="ts-service-box">
            ...
            <div class="d-flex">
              ...
              <div class="ts-service-info">
                  <h3 class="service-box-title"><a href="detail.off?groupNum=2" target="_blank">Build To Last</a></h3>
                  <p>You have ideas, goals, and dreams. We have a culturally diverse, forward thinking team looking for talent like. Lorem ipsum dolor suscipit.</p>
                  <a class="learn-more d-inline-block" href="service-single.html" aria-label="service-details"><i class="fa fa-caret-right"></i> Learn more</a>
              </div>
            </div>
      ...
      <div class="col-lg-4 col-md-6 mb-5">
        <div class="ts-service-box">
            ...
            <div class="d-flex">
              ...
              <div class="ts-service-info">
                  <h3 class="service-box-title"><a href="detail.off?groupNum=2" target="_blank">EXTERIOR DESIGN</a></h3>
                  <p>You have ideas, goals, and dreams. We have a culturally diverse, forward thinking team looking for talent like. Lorem ipsum dolor suscipit.</p>
                  <a class="learn-more d-inline-block" href="service-single.html" aria-label="service-details"><i class="fa fa-caret-right"></i> Learn more</a>
              </div>
            </div>
      ...
      <div class="col-lg-4 col-md-6 mb-5">
        <div class="ts-service-box">
            ...
            <div class="d-flex">
              ...
              <div class="ts-service-info">
                  <h3 class="service-box-title"><a href="detail.off?groupNum=2" target="_blank">RENOVATION</a></h3>
                  <p>You have ideas, goals, and dreams. We have a culturally diverse, forward thinking team looking for talent like. Lorem ipsum dolor suscipit.</p>
                  <a class="learn-more d-inline-block" href="service-single.html" aria-label="service-details"><i class="fa fa-caret-right"></i> Learn more</a>
              </div>
            </div>
      ...
      <div class="col-lg-4 col-md-6 mb-5">
        <div class="ts-service-box">
            ...
            <div class="d-flex">
              ...
              <div class="ts-service-info">
                  <h3 class="service-box-title"><a href="detail.off?groupNum=2" target="_blank">SAFETY MANAGEMENT</a></h3>
                  <p>You have ideas, goals, and dreams. We have a culturally diverse, forward thinking team looking for talent like. Lorem ipsum dolor suscipit.</p>
                  <a class="learn-more d-inline-block" href="service-single.html" aria-label="service-details"><i class="fa fa-caret-right"></i> Learn more</a>
              </div>
            </div>
