   ...
   ================================================== -->
    ...
    <body>
                      ...
                      <nav class="navbar navbar-expand-lg navbar-light p-0">
                        ...
                        <div class="logo">
                          <a class="d-block" href="${pageContext.request.contextPath}">
                            <img loading="lazy" src="${pageContext.request.contextPath}/resources/images/logo_1.png"
                              alt="">
                          </a>
                        </div><!-- logo end -->
                        ...
                        <ul class="dropdown-menu" role="menu">
                          ...
                          <li class="dropdown-submenu">
                            ...
                            <c:if test="${not empty loginUser }">
                              ...
                              <li class="nav-item">
                                <i style="margin-bottom:10px;" id="bellIcon"
                                  class="fa-sharp fa-solid fa-bell position-relative" tabindex="0" data-toggle="popover"
                                  data-toggle="popover" title="최신 알림" data-html="true" data-content="
						    			  <div>최신 알림이 없습니다.</div>" data-placement="bottom"></i>
                                <span
                                  class="position-absolute top-0 start-100 translate-middle p-2 bg-danger border border-light rounded-circle visually-hidden"></span>
                              </li>
                            </c:if>
                          </ul>
                              ...
                              <c:choose>
                                ...
                                <c:otherwise>
                                  ...
                                  <label id="table-avatar">
                                    <a id="table-avatar" href="${ loginUser.memImg }" target="_blank"><img
                                        class="rounded-circle" src="${ loginUser.memImg }" alt="User Image"></a>
                                  </label>&nbsp;&nbsp;
     ...
     ================================================== -->
            ...
            <!-- shuffle -->
            <script src="${pageContext.request.contextPath}/resources/plugins/shuffle/shuffle.min.js"
              defer="defer"></script>
