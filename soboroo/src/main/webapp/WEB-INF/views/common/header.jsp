<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
	...
	================================================== -->
			...
			<!-- FontAwesome -->
			<link rel="stylesheet"
				href="${pageContext.request.contextPath}/resources/plugins/fontawesome/css/all.min.css">
			<!-- Animation -->
									...
									<div id="navbar-collapse" class="collapse navbar-collapse">
										<ul class="nav navbar-nav mr-auto align-items-center">
											...
											<li class="nav-item dropdown">
												<a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">온라인
											...
											<li class="nav-item dropdown">
												<a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">오프라인
													<i class="fa fa-angle-down"></i></a>
												<ul class="dropdown-menu" role="menu">
												...
												<ul class="dropdown-menu" role="menu">
													...
													<li class="dropdown-submenu">
														<a href="myBoard.my" class="dropdown-toggle"
															data-toggle="dropdown">나의 활동 내역</a>
														<ul class="dropdown-menu">
