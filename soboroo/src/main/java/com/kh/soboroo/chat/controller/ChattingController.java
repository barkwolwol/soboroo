package com.kh.soboroo.chat.controller;
...
import com.kh.soboroo.chat.model.service.ChatServiceImpl;
...
public class ChattingController {
	...
	public String createRoom(int checkNo, HttpSession session) {
		Member loginUser = (Member)session.getAttribute("loginUser");
		int[] cUser = {loginUser.getMemNo(), checkNo};
		Member m = cService.selectMember(loginUser.getMemNo());
		Member om = cService.selectMember(checkNo);
		//m.setRoomTitle2(om.getMemName());
		//m.setChangeName2(om.getMemImg());
